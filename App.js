...
import ResourceDescription from "./screens/ResourceDescription";
...
function LocalNavigator() {
  const { authorized, user, setUser, setAuthorized } = useContext(AuthContext);
      ...
      {authorized ? (
        <>
          ...
          <Stack.Screen
            ...
            options={{ headerTitle: (props) => <Title text="Resource" /> }}
          />
          <Stack.Screen
            name="Subject"
            component={Subject}
