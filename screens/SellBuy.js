            ...
            <ScrollView>
                <View style={styles.postContainer}>
                    ...
                    <View style={styles.textContainer}>
                        <Text style={[styles.text, { color: 'red', fontSize: 20, fontWeight: '600' }]}>For Sale</Text>
                        ...
                        <Text style={styles.text}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aliquam incidunt eos corporis nihil quia, maiores fugiat omnis quas fuga voluptatibus aut labore illum eaque perferendis dolor, ad dolorum? Minus, repellendus.</Text>
...
const LostFound = ({ navigation }) => {
    ...
    return (
        <>
            ...
            >
                <Tab.Screen name="For Sale" component={AllPostScreen} />
                <Tab.Screen name="Wanted" component={WantedPostScreen} />
