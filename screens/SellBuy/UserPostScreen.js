...
const UserPostScreen = () => {
  ...
  useEffect(() => {
    sellBuyRef.where("creater", "==", user.email).onSnapshot((querySnapshot) => {
      const posts = [];
    ...
    <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            >
                ...
                <ScrollView>
                    ...
                    <View style={styles.formGroup}>
                        <Text style={{ color: '#5ca1f7', fontWeight: '500' }}>Product Name</Text>
                        <TextInput
                            style={styles.input}
                    ...
                    <View style={styles.formGroup}>
                        <Text style={{ color: '#5ca1f7', fontWeight: '500' }}>Expected Price</Text>
                        <TextInput
                            style={styles.input}
                    ...
                    <View style={styles.formGroup}>
                        ...
                        >
                            <Picker.Item style={{ color: "#666" }} label="Sell" value="Sell" />
